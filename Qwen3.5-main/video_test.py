#!/usr/bin/env python3
"""Smoke test client for sending a video prompt to a local vLLM endpoint."""
...
def file_to_data_url(path: pathlib.Path) -> str:
    """Convert a local video file into a data URL.

    Args:
        path: Path to the local video.

    Returns:
        A `data:` URL containing the base64 encoded file contents.
    """
